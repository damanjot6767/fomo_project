...
const createChatService = (user, createChatDto) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (chat === null || chat === void 0 ? void 0 : chat[0]) {
        ...
        let chatResponse = yield (0, chat_model_1.createChat)(createChatDto);
        chatResponse = yield (0, chat_model_1.getAggregationChatById)(chatResponse._id);
        return chatResponse;
    }
});
exports.createChatService = createChatService;
const getChatService = (user, id) => __awaiter(void 0, void 0, void 0, function* () {
    const chat = yield (0, chat_model_1.getAggregationChatById)(id);
    return chat;
});
exports.getChatService = getChatService;
const getChatByUserIdService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const chat = yield (0, chat_model_1.getAggregationChatsByUserId)(id);
    return chat;
});
