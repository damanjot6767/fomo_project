...
exports.updateMessageById = exports.deleteMessageById = exports.createMessage = exports.createManyMessage = exports.getMessagesByChatId = exports.getMessageById = exports.MessageModel = exports.messageSchema = void 0;
...
const getMessagesByChatId = (id, page = 1, limit = 10) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const isCacheMessages = yield (0, message_redis_service_1.pullMessageRedis)(id);
        if ((isCacheMessages === null || isCacheMessages === void 0 ? void 0 : isCacheMessages.length) >= 100)
            return isCacheMessages;
        limit = 100 - (isCacheMessages === null || isCacheMessages === void 0 ? void 0 : isCacheMessages.length);
        const message = yield exports.MessageModel.aggregate([
            {
                $match: {
...
const createManyMessage = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield exports.MessageModel.insertMany(payload);
        return response;
    }
    catch (error) {
        throw new api_error_1.ApiError(500, "Something went wrong while create messages");
    }
});
exports.createManyMessage = createManyMessage;
